...
return [
	...
	'modules' => [
		...
		'mon-espace.auto-amelia-customer' => [
			'label'           => 'Création auto entité Amelia à l\'inscription',
			'description'     => 'Crée automatiquement une entité Amelia customer chaque fois qu\'un compte WP est créé (inscription /mon-compte/, checkout, wp-admin). Sans ce module, l\'entité Amelia n\'est créée qu\'à la première réservation → /mon-espace/ affiche "non connecté Amelia" pour les nouveaux comptes. Defensive : si l\'INSERT plante, l\'inscription WP réussit quand même.',
			'category'        => 'mon-espace',
			'type'            => 'php',
			'file'            => 'includes/modules/auto-amelia-customer.php',
			'requires_plugin' => [ 'ameliabooking/ameliabooking.php' => 'Amelia' ],
			'github_path'     => 'plugins/cordespace-snippets/includes/modules/auto-amelia-customer.php',
			'default_active'  => true,
		],
		'mon-espace.login-redirect' => [
			'label'           => 'Redirect login vers Mon espace',
			'description'     => 'Redirige les user·trice·s non-admin vers /mon-espace/ après connexion ou activation de compte, au lieu de wp-admin. Préserve un redirect_to explicite (par ex. retour au checkout après inscription depuis le bandeau gating).',
			'category'        => 'mon-espace',
			'type'            => 'php',
			'file'            => 'includes/modules/login-redirect.php',
			'requires_plugin' => [],
			'github_path'     => 'plugins/cordespace-snippets/includes/modules/login-redirect.php',
			'default_active'  => true,
		],
